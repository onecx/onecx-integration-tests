...
#   docker run --rm -e BASE_URL=http://onecx-shell-ui:8080/onecx-shell/admin/workspace -v $(pwd)/e2e-results:/e2e-results --network=<testcontainer-network> onecx-workspace-e2e:latest
